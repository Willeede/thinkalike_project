...
1.  **Read the [Onboarding Guide](onboarding_guide.md) and [Quickstart Guide](quickstart_guide.md).** These documents provide an overview of the project, its goals, and how to set up your development environment.  *These are now correct relative links.*
